...
`ProcessTransport` owns execution and protocol mechanics: argv execution with
`shell=False`, minimal environment construction, timeout, request ID generation, stdout
